...
const jumpData = {
	// New York - планетарная система
	"New York": {
		// Colorado и остальные ключи этого уровня вложенности - гиперворота и прыжковые дыры,
		// присутствующие в системе.
		"Colorado": [
			// Члены этого массива - объекты, описывающие тип и местонахождение ворот/дыр в систему,
			// наименованием которой является ключ уровнем выше.
			{ 
				loc: "c3",
				// Координаты объекта на карте планетарной системы. Буквы обозначают абсциссу, цифры - ординату.
				// Указанием пары символов (AB или 12) указывается граница между соседними квадратами на карте.
				gate: false, 
				// Признак вида (ворота/дыра). Если true - гиперворота, false - прыжковая дыра.
				hidden: false 
	...
	"Sigma 13": {
		...
		"Chugoku": { loc: "d4", gate: false, hidden: false }
	},
	"Sigma 17": {
